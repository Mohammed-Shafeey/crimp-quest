...
// Shop economy — selling an inventory item pays out at its rarity's sell
// price, buying a shop listing costs its rarity's buy price.
const RARITY_SELL_PRICE = { common: 5, rare: 25, epic: 125, legendary: 750 };
const RARITY_BUY_PRICE = { common: 10, rare: 35, epic: 150, legendary: 1000 };
...
const GEAR_CATALOG = {
  ...
  shoes: {
    common: [
      ...
      {
        id: "la_sportiva_stick_kit",
        name: "La Sportiva Stick Kit",
        image: "data:image/png;base64,",
      },
      {
        id: "wild_climb_pantera_v2",
        name: "Wild Climb Pantera V2",
        image: "data:image/png;base64,",
      },
    ],
    legendary: [
      {
    ...
    rare: [
      ...
      {
        id: "la_sportiva_miura",
        name: "La Sportiva Miura",
        image: "data:image/png;base64,",
      },
      {
        id: "la_sportiva_tarantula",
        name: "La Sportiva Tarantula",
        image: "data:image/png;base64,",
      },
      {
        id: "scarpa_zenit",
        name: "Scarpa Zenit",
        image: "data:image/png;base64,",
      },
    ],
    epic: [
      {
      ...
      {
        id: "la_sportiva_instinct_vsr",
        name: "La Sportiva Instinct VSR",
        image: "data:image/png;base64,",
      },
    ],
  },
  harness: {
  ...
  chalk: {
    common: [
      ...
      {
        id: "black_diamond_mojo",
        name: "Black Diamond Mojo",
        image: "data:image/png;base64,",
      },
      {
        id: "mammut_basic_chalk_bag",
        name: "Mammut Basic Chalk Bag",
        image: "data:image/png;base64,",
      },
      {
        id: "ocun_push",
        name: "Ocun Push",
        image: "data:image/png;base64,",
      },
    ],
    rare: [
      {
      ...
      {
        id: "evolv_corduroy_chalk_bag",
        name: "Evolv Corduroy Chalk Bag",
        image: "data:image/png;base64,",
      },
      {
        id: "sierra_climbing_tube",
        name: "Sierra Climbing Tube",
        image: "data:image/png;base64,",
      },
    ],
    epic: [
      {
      ...
      {
        id: "sierra_chalk_bucket",
        name: "Sierra Chalk Bucket",
        image: "data:image/png;base64,",
      },
    ],
    legendary: [
      {
  ...
  trainingTool: {
    common: [
      ...
      },
      {
        id: "grip_trainer",
        name: "Grip Trainer",
        image: "data:image/png;base64,",
      },
    ],
    rare: [
      {
      ...
      {
        id: "hex_finger_board",
        name: "Hex Finger Board",
        image: "data:image/png;base64,",
      },
    ],
    epic: [
      {
    ...
    legendary: [
      ...
      {
        id: "granite_finger_board",
        name: "Granite Finger Board",
        image: "data:image/png;base64,",
      },
    ],
  },
  wall: {
...
/* --------------------------- HOLD SETS ------------------------------ */
/* Bundled wall-hold sets sold only through the Shop's set slot — never
   as individual chest drops or single shop listings. Buying a set adds
   every hold in it to the inventory in one purchase. */
const HOLD_SETS = {
  ocean_slopers: {
    id: "ocean_slopers",
    name: "Ocean Slopers",
    rarity: "epic",
    previewImage: "data:image/png;base64,",
    previewW: 168,
    previewH: 160,
    holds: [
      { id: "ocean_slopers_1", name: "Ocean Slopers #1", w: 46, h: 50, image: "data:image/png;base64," },
      { id: "ocean_slopers_2", name: "Ocean Slopers #2", w: 47, h: 40, image: "data:image/png;base64," },
      { id: "ocean_slopers_3", name: "Ocean Slopers #3", w: 53, h: 41, image: "data:image/png;base64," },
      { id: "ocean_slopers_4", name: "Ocean Slopers #4", w: 43, h: 38, image: "data:image/png;base64," },
      { id: "ocean_slopers_5", name: "Ocean Slopers #5", w: 35, h: 36, image: "data:image/png;base64," },
      { id: "ocean_slopers_6", name: "Ocean Slopers #6", w: 21, h: 33, image: "data:image/png;base64," },
      { id: "ocean_slopers_7", name: "Ocean Slopers #7", w: 27, h: 28, image: "data:image/png;base64," },
    ],
  },
  cherry_breakers: {
    id: "cherry_breakers",
    name: "Cherry Breakers",
    rarity: "epic",
    previewImage: "data:image/png;base64,",
    previewW: 216,
    previewH: 148,
    holds: [
      { id: "cherry_breakers_1", name: "Cherry Breakers #1", w: 70, h: 62, image: "data:image/png;base64," },
      { id: "cherry_breakers_2", name: "Cherry Breakers #2", w: 67, h: 52, image: "data:image/png;base64," },
      { id: "cherry_breakers_3", name: "Cherry Breakers #3", w: 48, h: 49, image: "data:image/png;base64," },
      { id: "cherry_breakers_4", name: "Cherry Breakers #4", w: 45, h: 48, image: "data:image/png;base64," },
      { id: "cherry_breakers_5", name: "Cherry Breakers #5", w: 40, h: 38, image: "data:image/png;base64," },
    ],
  },
  soft_venom: {
    id: "soft_venom",
    name: "Soft Venom",
    rarity: "epic",
    previewImage: "data:image/png;base64,",
    previewW: 204,
    previewH: 144,
    holds: [
      { id: "soft_venom_1", name: "Soft Venom #1", w: 49, h: 49, image: "data:image/png;base64," },
      { id: "soft_venom_2", name: "Soft Venom #2", w: 46, h: 46, image: "data:image/png;base64," },
      { id: "soft_venom_3", name: "Soft Venom #3", w: 46, h: 47, image: "data:image/png;base64," },
      { id: "soft_venom_4", name: "Soft Venom #4", w: 37, h: 31, image: "data:image/png;base64," },
      { id: "soft_venom_5", name: "Soft Venom #5", w: 21, h: 37, image: "data:image/png;base64," },
      { id: "soft_venom_6", name: "Soft Venom #6", w: 20, h: 35, image: "data:image/png;base64," },
    ],
  },
  honeycomb: {
    id: "honeycomb",
    name: "Honeycomb",
    rarity: "epic",
    previewImage: "data:image/png;base64,",
    previewW: 188,
    previewH: 168,
    holds: [
      { id: "honeycomb_1", name: "Honeycomb #1", w: 34, h: 47, image: "data:image/png;base64," },
      { id: "honeycomb_2", name: "Honeycomb #2", w: 46, h: 26, image: "data:image/png;base64," },
      { id: "honeycomb_3", name: "Honeycomb #3", w: 35, h: 33, image: "data:image/png;base64," },
      { id: "honeycomb_4", name: "Honeycomb #4", w: 31, h: 38, image: "data:image/png;base64," },
      { id: "honeycomb_5", name: "Honeycomb #5", w: 40, h: 30, image: "data:image/png;base64," },
      { id: "honeycomb_6", name: "Honeycomb #6", w: 30, h: 33, image: "data:image/png;base64," },
      { id: "honeycomb_7", name: "Honeycomb #7", w: 30, h: 30, image: "data:image/png;base64," },
      { id: "honeycomb_8", name: "Honeycomb #8", w: 34, h: 28, image: "data:image/png;base64," },
      { id: "honeycomb_9", name: "Honeycomb #9", w: 34, h: 31, image: "data:image/png;base64," },
      { id: "honeycomb_10", name: "Honeycomb #10", w: 24, h: 27, image: "data:image/png;base64," },
    ],
  },
};
const HOLD_SET_ORDER = ["ocean_slopers", "cherry_breakers", "soft_venom", "honeycomb"];
...
/* --------------------------- SHOP ------------------------------------ */
/* Daily-rotating hold shop: 10 single holds (4 common/4 rare/2 epic) drawn
   without replacement from the same wall-hold catalog chests use, plus
   one featured bundle from HOLD_SETS. Regenerates once per calendar day
   (see the shop-refresh effect); each listing is snapshotted at
   generation time and is limited stock — buying it removes it from
   today's shop until the next refresh. */
const generateShop = (data) => {
  const catalog = getEffectiveCatalog(data);
  const pick = (rarity, n) => {
    const pool = [...(catalog.wall?.[rarity] || [])];
    const out = [];
  ...
  const singles = [...pick("common", 4), ...pick("rare", 4), ...pick("epic", 2)];
  const setId = HOLD_SET_ORDER[Math.floor(Math.random() * HOLD_SET_ORDER.length)];
  return { date: today(), singles, boughtSingleIds: [], setId, setBought: false };
};
...
const seed = () => ({
  ...
  coins: 50, // shop currency — earned by selling inventory items, spent in the Shop tab
  shop: null, // today's rotating listings — regenerated by the shop-refresh effect: { date, singles, boughtSingleIds, setId, setBought }
});
...
export default function CrimpQuest() {
  ...
  /* -------- shop refresh — regenerates the day's hold listings the
     first time the app is opened each day, independent of which tab
     is open. -------- */
  useEffect(() => {
    if (!data) return;
    if (!data.shop || data.shop.date !== today()) {
      persist((prev) => ({ ...prev, shop: generateShop(prev) }));
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [data && (!data.shop || data.shop.date === today())]);
  ...
  return (
    <Shell>
      ...
      {tab === "shop" && <ShopTab data={data} persist={persist} />}
      {tab === "timer" && <TimerTab />}
...
/* ------------------------------ SHOP -------------------------------- */
/* Two-part daily hold shop: 10 single listings (see generateShop) plus
   one featured HOLD_SETS bundle. Each listing is limited stock for the
   day — buying it marks it sold until tomorrow's refresh. */
function ShopTab({ data, persist }) {
  ...
  const buySingle = (listing) => {
    if (shop.boughtSingleIds.includes(listing.id) || coins < RARITY_BUY_PRICE[listing.rarity]) return;
    const price = RARITY_BUY_PRICE[listing.rarity];
    const newItem = {
      id: uid(),
      tier: "shop",
  ...
  const setPrice = set ? RARITY_BUY_PRICE[set.rarity] * set.holds.length : 0;

  const buySet = () => {
    if (!set || shop.setBought || coins < setPrice) return;
    const newItems = set.holds.map((hold) => ({
      id: uid(),
      tier: "shop",
      rarity: set.rarity,
      slot: "wall",
  ...
  return (
    <div>
      <Panel style={{ padding: 14, marginBottom: 14 }} accent={C.gold}>
        ...
        >
          <span style={{ fontFamily: "'Press Start 2P', monospace", fontSize: 12, color: C.gold }}>
            SHOP
          </span>
          <span style={{ fontFamily: "'Press Start 2P', monospace", fontSize: 12, color: C.gold }}>
            🪙 {coins}
        ...
        <div style={{ fontFamily: "'VT323', monospace", fontSize: 14, color: C.boneDim }}>
          Fresh holds every day. Sell duplicate items from your inventory (Profile) for coins, then
          spend them here.
        </div>
      </Panel>
        ...
        <Panel style={{ padding: 14, marginBottom: 14 }} accent={C.magenta}>
          ...
          <div
            style={{
              fontFamily: "'VT323', monospace",
              fontSize: 14,
              color: RARITY[set.rarity].color,
              textAlign: "center",
              marginBottom: 10,
            }}
          >
            {set.holds.length} {RARITY[set.rarity].label} HOLDS
          </div>
          <div
            style={{
              display: "flex",
            ...
            {set.holds.map((hold) => (
              <div
                ...
                style={{
                  width: 44,
                  height: 44,
                  border: `2px solid ${RARITY[set.rarity].color}`,
                  background: C.bgDeep,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
          ...
          <Btn onClick={buySet} color={C.magenta} disabled={shop.setBought || coins < setPrice} full>
            {shop.setBought ? "Sold — back tomorrow" : `Buy full set — 🪙 ${setPrice}`}
          </Btn>
        </Panel>
      )}
      ...
      <Panel style={{ padding: 14 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
          {shop.singles.map((listing) => {
            const bought = shop.boughtSingleIds.includes(listing.id);
            const price = RARITY_BUY_PRICE[listing.rarity];
            return (
              <div key={listing.id} style={{ width: 92, textAlign: "center" }}>
                <div
                  style={{
                    width: 60,
                    height: 60,
                    margin: "0 auto 6px",
                    border: `2px solid ${RARITY[listing.rarity].color}`,
                    background: C.bgDeep,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                <div
                  style={{
                    fontFamily: "'VT323', monospace",
                    fontSize: 12,
                    color: RARITY[listing.rarity].color,
                    marginBottom: 4,
                  }}
                >
                  {RARITY[listing.rarity].label}
                </div>
                <Btn small onClick={() => buySingle(listing)} color={C.cyan} disabled={bought || coins < price} full>
                  {bought ? "SOLD" : `🪙 ${price}`}
                </Btn>
              </div>
            );
                ...
                <>
                  ...
                  {!mergeMode && invSelectedId &&
                    (() => {
                      ...
                      const isPlaced = (data.wallHolds || []).some((w) => w.lootItemId === item.id);
                      const sellPrice = RARITY_SELL_PRICE[item.rarity];
                      const sellItem = () => {
                        if (isEquipped || isPlaced) return;
                        persist((prev) => ({
                          ...prev,
                      ...
                      return (
                        ...
                        >
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <div style={{ marginTop: 6 }}>
                              <Btn small color={C.gold} onClick={sellItem} disabled={isEquipped || isPlaced}>
                                {`Sell — 🪙 ${sellPrice}`}
                              </Btn>
                              {(isEquipped || isPlaced) && (
                                <div style={{ fontFamily: "'VT323', monospace", fontSize: 12, color: C.boneDim, marginTop: 4 }}>
                                  {isEquipped ? "Unequip first to sell." : "Remove from the wall first to sell."}
                                </div>
                              )}
                            </div>
                          </div>
